	soc_system u0 (
		...
		.image_ram_out_write                   (<connected-to-image_ram_out_write>),                   //                               .write
		.image_ram_out_readdata                (<connected-to-image_ram_out_readdata>),                //                               .readdata
		.image_ram_out_writedata               (<connected-to-image_ram_out_writedata>),               //                               .writedata
		.image_ram_out_byteenable              (<connected-to-image_ram_out_byteenable>),              //                               .byteenable
